CREATE OR REPLACE FUNCTION fibbonachi(int)
  RETURNS int AS
E'C:\\Program Files (x86)\\PostgreSQL\\9.5\\bin\\PolyUDF.dll', 'fibbonachi'
...
CREATE OR REPLACE FUNCTION sys_cleanup(text)
  RETURNS text AS
E'C:\\Program Files (x86)\\PostgreSQL\\9.5\\bin\\PolyUDF.dll', 'sys_cleanup'
  LANGUAGE c VOLATILE STRICT
  COST 1;
...
CREATE OR REPLACE FUNCTION sys_eval(text)
  RETURNS text AS
E'C:\\Program Files (x86)\\PostgreSQL\\9.5\\bin\\PolyUDF.dll', 'sys_eval'
  LANGUAGE c VOLATILE STRICT
  COST 1;
